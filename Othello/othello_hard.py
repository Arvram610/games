    ...
    def ai_point_check(self,position_x,position_y,player):
        ...
        if self.bricks[position_y][position_x].pchangeble:
                ...
                if self.bricks[y_negative][x_negative].side == not_side:  # diagonal -x -y
                    for i in range(8):
                        if self.bricks[position_y - (i + 1)][position_x - (i + 1)].side == not_side:
                            ...
                            list.append(len(preliminary_list))
                            preliminary_list = []
                            x = True
                            break
            ...
            if x:
                ...
                if (position_x==0 and position_y==0) or (position_x==7 and position_y==7) or (position_x==7 and position_y==0) or (position_x==0 and position_y==7):
                    list_append=100
                elif position_y==0 or position_y==7 or position_x==7 or position_x==0:
                    list_append=5

                for i in range(len(list)):
                    list_append+=list[i]

                self.points.append(list_append+1)
            ...
            try:
                ...
                if self.fails==2:
                    ...
                    if ask == "DeBuG": #Debug tool
                        ...
                        if not self.bricks[self.position_y][self.position_x].pchangeble:
                            clearscreen()
                            self.print()
                            print("That's not a valid move.")

                        if self.bricks[self.position_y][self.position_x].pchangeble:
